#' HERS data example
#'
#' This dataset contains data from the HERS study used for demonstration purposes.
#' Missing data (7-8%) has been omitted.
#'
#' @format A data frame with `n` rows and `p` variables:
#' \describe{
